    ...
    <div className="relative aspect-square w-full max-w-md overflow-hidden rounded-3xl bg-muted/10 p-4 sm:p-8 shadow-2xl">
      <div className="grid h-full w-full grid-cols-3 grid-rows-3">
        {pieces.map((piece) => {
          ...
          const xDir = (piece.col - 1) * 35; // -35, 0, 35
          const yDir = (piece.row - 1) * 35; // -35, 0, 35
          ...
          return (
            <motion.div
              ...
              animate={{
                x: [0, 0, xDir * 0.2, xDir, xDir * 1.1, xDir, xDir * 0.2, 0, 0],
                y: [0, 0, yDir * 0.2, yDir, yDir * 1.1, yDir, yDir * 0.2, 0, 0],
